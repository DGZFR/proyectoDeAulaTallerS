	...
	<div class="starter-template">
		...
		<div class="jumbotron">
			<div class="container text-center">
				<h1><strong>Busqueda Proveedor</strong> </h1>
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <a href="proveedores.php" id="btnsearch" style="border:1px solid #CCC;  width:210px; height:30px;">Salir De Busqueda</a>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #033; color:#033;">
     ...
     <tr>
     <th colspan="7" align="center" height="55px" style="border-bottom:1px solid #030; background: #030; color:#FFF;"> <p align="center"> Resultados Busqueda De Proveedor </p>	</th>
    </tr>
      ...
      <tr height="30px">
        ...
        <th style="border-bottom:1px solid #333;">Acciones</th>
					...
					if(isset($_GET['search'])){
						...
						$sql = "select * from proveedor where nombreprov like '%$query%' or encargado like '%$query%'";
