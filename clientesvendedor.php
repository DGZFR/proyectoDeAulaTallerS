...
<div class="container">
	<div class="starter-template">
      ...
      <tr>
        ...
        <a href="registroclientesvendedor.php""><input type="button" style="border:1px solid #999; background: #999; height:45px; width:125px; color:#FFF; border-radius:3px; font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;" value="Nuevo Cliente" /></a></td>
      </tr>
