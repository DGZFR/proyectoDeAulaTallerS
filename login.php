...
<head>
 ...
 <script type="text/javascript">
   ...
   {
	alert("Please Ingresa tu usuario");

    }else{
		  document.getElementById("data").innerHTML = "Por favor espera...";
      var xmlhttp;
				...
				<div class="container">
					...
					<div class="nav-mini-wrapper">
						<ul class="nav-mini sign-in">
                            ...
                            <div style="position:absolute; left:900px;  "><a class="btn btn-primary" href="registrarse.php?p=vendedor">Registrarse</a></div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list">
						...
						<li><a href="registrarse.php?p=vendedor"><span>Registrarse</span></a></li>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<p align="center"><a href="./"><img src="vista/images3/logo.png" alt="Logo" /></a></p>
                                ...
                                <label>Usuario</label>
                                <input class="form-control" placeholder="Ingrese su usuario" name="usuario" required type="text"> 
                                </div>
